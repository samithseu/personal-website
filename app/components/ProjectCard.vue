...
<template>
  ...
  >
    ...
    <div class="p-4 lg:p-6 space-y-4 lg:space-y-5">
      <h3
        class="text-sm lg:text-xl font-semibold transition-colors duration-200 group-hover:text-primary capitalize"
      >
        {{ props.title.replaceAll("-", " ") }}
      </h3>
      <p :title="props.description" class="text-sm line-clamp-2 text-zinc-400">
        {{ props.description }}
      </p>
