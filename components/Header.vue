...
<template>
  <header
    class="bg-dark/70 w-full border-b border-dashed border-primary/20 py-4 px-4 prefer:px-0 sticky top-0 left-0 z-50 backdrop-blur-md backdrop-brightness-75 h-fit"
  >
